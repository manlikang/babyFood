...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
            <a href="back/page/goods/goodsadd.jsp"> <li class="click"><span><img src="back/style/images/t01.png" /></span>添加</li></a>
    ...
    <table class="tablelist" >
        ...
        <c:forEach items="${pageInfo.list}" var ="food">
	        <tr>
	        <td><input name="" class="checkbox" type="checkbox" value="${food.id}" /></td>
	        <td>${food.id}</td>
	        <td>${food.foodName}</td>

                <td>${food.qualityTime}</td>
                <td>${food.foodtype}</td>
	        <td align="center"><img src="back/style/img/${food.foodpic}" onerror="this.src='back/style/images/wenhao.jpg'" style="width: 120px;height: 90px;" align="middle"/></td>
	        <td>${food.foodPrice}</td>
	        <td>
	        <a href="food/toUpdate/${food.id}" >编辑</a>|
			<a  class="delGoods" style="cursor: pointer" goodsId="${food.id}" > 删除</a>
			</td>
	        </tr>
	        </c:forEach>
        </tbody>
