						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="user/addAddress2/<shiro:principal property='id'/>" method="post">
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												...
												<a href="/user/toMember/<shiro:principal property="id"/>/5" class="am-close am-btn am-btn-danger" data-am-modal-close>返回</a>
											</div>
										</div>
									</form>
								</div>
