...
<script type="text/javascript">
	$(function(){
		...
		$("#addShopCart").click(function(){
			var val = $("#value").val();
			var id = ${goods.id};
			$.get("shs?action=addShopCart&id="+id+"&count="+val,function(data){
				if(data == 1){
					alert("添加成功")
					location.reload();
				}else{
...
<body>
	...
	<div class="listMain">
		...
		<div class="nav-table">
			...
			<div class="nav-cont">
				<ul>
					<li class="index"><a href="shs?action=loginlist">首页</a></li>
		...
		<ol class="am-breadcrumb am-breadcrumb-slash">
			<li><a href="shs?action=loginlist">首页</a></li>
			<li><a href="#">分类</a></li>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="#"><img src="images/${goods.goods_pic}"
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						...
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${goods.goods_price_off}</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${goods.goods_price}</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<dd>
													...
													<span class="stock" id="stock">${goods.goods_stock}</span>件
													</span>
												</dd>
				...
				<div class="pay">
					...
					<li>
						<div class="clearfix tb-btn tb-btn-basket theme-login">
							<a id="addShopCart" title="加入购物车" ><i></i>加入购物车</a>
						</div>
					</li>
				</div>
